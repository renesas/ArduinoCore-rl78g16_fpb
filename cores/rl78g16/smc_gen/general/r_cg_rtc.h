...
#define _00_RTC_CLK_FSUB                                      (0x00U)    /* subsystem clock (fSUB) */
...
#define _00_RTC_CORRECTION_TIMING_INT_DISABLE                 (0x00U)    /* disables the correction timing
                                                                            signal interrupt */
#define _20_RTC_CORRECTION_TIMING_INT_ENABLE                  (0x20U)    /* enables the correction timing
                                                                            signal interrupt */
