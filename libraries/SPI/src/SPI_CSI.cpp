...
extern "C" {
  ...
  extern volatile uint16_t g_csi00_tx_count;
  extern volatile uint16_t g_csi00_status_flag;
#endif
...
#if     defined(CSI_CHANNEL0) && CSI_CHANNEL0 == 0
  case 0:
    Master_Create_          = R_Config_CSI00_Create;
    Master_Start_           = R_Config_CSI00_Start;
    Master_Stop_            = R_Config_CSI00_Stop;
    Master_Create_UserInit_ = R_Config_CSI00_Create_UserInit;
    Master_ClearStatus_     = R_Config_CSI00_ClearStatus;
    Master_Send_Receive_    = R_Config_CSI00_Send_Receive;
    Master_SetBitOrder_     = R_Config_CSI00_SetBitOrder;
    Master_SetDataMode_     = R_Config_CSI00_SetDataMode;
    Master_SetClockDivider_ = R_Config_CSI00_SetClockDivider;
    Master_SetClock_        = R_Config_CSI00_SetClock;
    Master_GetBitOrder_     = R_Config_CSI00_GetBitOrder;
    master_tx_count         = &g_csi00_tx_count;
    master_status_flag      = &g_csi00_status_flag;
    break;
#endif /* defined(CSI_CHANNEL0) && CSI_CHANNEL0 == 0 */
