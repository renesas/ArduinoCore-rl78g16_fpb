...
public:
  ...
  inline uint16_t getRxLen           (void) const { return rx_len             == nullptr ? 0 : *rx_len            ; }
  inline uint16_t getRxCnt           (void) const { return rx_cnt             == nullptr ? 0 : *rx_cnt            ; }
  inline uint16_t getTxCnt           (void) const { return tx_cnt             == nullptr ? 0 : *tx_cnt            ; }
  inline uint8_t  getMasterStatusFlag(void) const { return master_status_flag == nullptr ? 0 : *master_status_flag; }
